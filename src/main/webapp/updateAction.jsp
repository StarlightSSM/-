...
<body>
	...
	String sql = "update writing SET w_day = ?, w_emotion = ?, w_title = ?, w_img = ?, w_content = ? WHERE w_id =?";
	...
	int result = diaryDAO.update(dto.getEmail(), diaryDTO.getW_id(), day, title, emotion, img, content);
	// 데이터베이스 오류인 경우
	if (result == -1) {
